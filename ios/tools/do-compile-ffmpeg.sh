...
echo "[*] check fdk aac"
echo "----------------------"
FFMPEG_DEP_AAC_INC=$FF_BUILD_ROOT/build/$FF_BUILD_NAME_AAC/output/include
FFMPEG_DEP_AAC_LIB=$FF_BUILD_ROOT/build/$FF_BUILD_NAME_AAC/output/lib
#--------------------
# with fdk aac
if [ -f "${FFMPEG_DEP_AAC_LIB}/libfdk-aac.a" ]; then
